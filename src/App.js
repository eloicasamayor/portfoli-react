      ...
      <section id="portfolio">
        ...
        <div class="section-wrapper">
          ...
          <ul>
            <ItemProjecte
              titol="Projecte 1"
              descripcio="Descripcio del projecte 1"
              contingut="Text d'explicació del projecte 1 amb totes les caracteristiques i etc etc."
              descripcioFoto="Descripcio de la foto del projecte 1"
            />
            <ItemProjecte
              titol="Projecte 2"
              descripcio="Descripcio del projecte 2"
              contingut="Text d'explicació del projecte 2 amb totes les caracteristiques i etc etc."
              descripcioFoto="Descripcio de la foto del projecte 2"
            />
            <ItemProjecte
              titol="Projecte 3"
              descripcio="Descripcio del projecte 3"
              contingut="Text d'explicació del projecte 3 amb totes les caracteristiques i etc etc."
              descripcioFoto="Descripcio de la foto del projecte 3"
            />
            <ItemProjecte
              titol="Projecte 4"
              descripcio="Descripcio del projecte 4"
              contingut="Text d'explicació del projecte 4 amb totes les caracteristiques i etc etc."
